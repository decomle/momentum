          ...
          <div className="sticky bottom-[calc(env(safe-area-inset-bottom)+12px)] pointer-events-none">
            <div className="relative h-14 w-full">
              <button
                ...
                className={`absolute right-0 bottom-0 w-14 h-14 rounded-full btn-primary text-3xl leading-none shadow-lg flex items-center justify-center transition-[transform,opacity] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform ${
                  isAtBottom
              ...
              <button
                ...
                className={`absolute left-0 right-0 bottom-0 h-12 rounded-md btn-primary text-sm font-medium shadow-lg transition-[transform,opacity] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform ${
                  isAtBottom
                    ? "opacity-100 scale-100 translate-y-0 pointer-events-auto"
